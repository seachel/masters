...
%\newfontface\ftitle{Playfair Display}        % title
\newfontface\fhead{Open Sans Bold}          % headings
\newfontface\femph{Slabo 27px}            % emphasised points
%\newfontface\fbody{Open Sans Condensed Light}  % body text
%\newfontface\ftelet{Cutive Mono}          % teletype
%\newfontface\ftelet{Lekton}          % teletype
%\newfontface\ftelet{Anonymous Pro}          % teletype
%\newfontface\fpttitle{Open Sans Bold}  % title of point or subpoint
%\newfontface\fptbody{Slabo 27px} % body of point or subpoint
\newfontface\fblocktitle{Open Sans Bold}
%\newfontface\fframetitle{Playfair Display}
\newfontface\frule{Open Sans Condensed Light}
\newfontface\flobstertwo{Lobster Two}
...
\newcommand{\inddyncon}{c'}

% standard sequents
\newcommand{\seq}[2][\dyncon{}]{\ensuremath{#1 \vdash #2}}
\newcommand{\bch}[3][\dyncon{}]{\ensuremath{#1 , {[#2]} \vdash #3}}
...
\newtheoremstyle{thmstylec}% name of the style to be used
  ...
  {\rmfamily}% name of head font
  { }% punctuation between head and body
  { }% space after theorem head; " " = normal interword space
  {\bfseries{\thmname{#1}\thmnumber{ #2}}. \emph{\thmnote{ #3} ~\\}}

\theoremstyle{thmstylec}
\newtheorem{theorem}{Theorem}[chapter]
\newtheorem*{thm}{Theorem}
\newtheorem{corollary}{Corollary}[chapter]
\newtheorem{lemma}{Lemma}[chapter]
\newtheorem{defnc}{Definition}[chapter]
\newtheorem{expl}{Example}[chapter]
%\newtheorem*{expl}{Example}

\numberwithin{equation}{chapter}

\newenvironment{sidestory}{
  \hfill\begin{minipage}{\dimexpr\textwidth-2.3in}
  \itshape
}{
  \bigskip
  \end{minipage}
